...
Contributions are welcome. Validate the relevant IaC track before opening a
pull request.

```bash
# Validate before committing
az bicep build --file infra/bicep/smb-ready-foundation/main.bicep
terraform -chdir=infra/terraform/smb-ready-foundation fmt -check -recursive
terraform -chdir=infra/terraform/smb-ready-foundation validate
```
