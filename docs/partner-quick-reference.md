...
| Terraform implementation | [Terraform plan specifications](tf-plan-specs.md)           |
| Architecture diagrams    | [Architecture images](images/)                              |
| Management console       | [Management console guide](../management-console/README.md) |
...
# 3. Create the management group and associate the subscription
az account management-group create --name smb-rf --display-name "SMB Ready Foundations"
...
- [Terraform Templates](../infra/terraform/smb-ready-foundation/)
