...
- `infra/terraform/smb-ready-foundation/README.md` — Terraform deployment and module guide
- `infra/terraform/smb-ready-foundation/tests/scenarios.tftest.hcl` — plan-mode scenario tests
- `.github/workflows/terraform-smb-ready-foundation.yml` — Terraform CI checks
