...
The implementation is ready for `terraform test`, CI validation, and a real
`azd provision` run against an Azure subscription.
...
- Scenario tests: `infra/terraform/smb-ready-foundation/tests/scenarios.tftest.hcl`
