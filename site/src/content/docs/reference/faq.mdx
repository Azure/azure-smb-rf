...
No. A tenant administrator may be needed once to create the management group
and associate the subscription. Routine deployments require the permissions
listed in [Prerequisites](/azure-smb-rf/getting-started/prerequisites/).
